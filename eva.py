...
# Form implementation generated from reading ui file 'eva2.ui'
#
...
class Ui_evaluate_team(object):
    ...
    def setupUi(self, evaluate_team):
        ...
        self.scores_lw.setStyleSheet("color: rgb(3, 190, 159);")
        self.scores_lw.setObjectName("scores_lw")
        self.points = QtWidgets.QLabel(evaluate_team)
        self.points.setGeometry(QtCore.QRect(410, 160, 55, 16))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(10)
        self.points.setFont(font)
        self.points.setStyleSheet("color: rgb(3, 190, 159);")
    ...
    def retranslateUi(self, evaluate_team):
        ...
        self.selectmatch_cb.setItemText(0, _translate("evaluate_team", "match1"))
